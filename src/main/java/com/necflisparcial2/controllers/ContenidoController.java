...
import com.necflisparcial2.entities.Contenido;
import com.necflisparcial2.repositories.ContenidoRepository;
...
public class ContenidoController {
	...
	public Contenido updateContenido(@PathVariable(name = "id") Long id, 
		...
		Optional<Contenido> updContenido = repository.findById(id);
		if(updContenido.isPresent()) {
			Contenido actual = updContenido.get(); 
			actual.setId(id);
